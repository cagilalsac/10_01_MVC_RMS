...
insert into users (Id, IsActive, Password, RoleId, Status, UserName) values (1, 1, 'admin', 1, 1, 'admin')
insert into users (Id, IsActive, Password, RoleId, Status, UserName) values (2, 1, 'user', 2, 2, 'user')
insert into users (Id, IsActive, Password, RoleId, Status, UserName) values (3, 1, 'cagil', 2, 3, 'cagil')
